 ...
 * @param [params.Filedata] {File} - _[optional]_ The file to be created in Elvis
 * @param [params.metadata] {Object} - _[optional]_ Object containing Elvis fields
 * @param [params.nextUrl] {String} - _[optional]_ 301 redirect will happen to this URL if specified
 * @returns {Promise}
 */
